...
export class Renderer {
	...
	protected setUniform(name: string, value: Float32List | mat4) {
	...
	protected drawMesh(mesh: Mesh, options: { pos?: boolean, color?: boolean, texture?: boolean, normal?: boolean, blockPos?: boolean }) {
		if (mesh.quadVertices() > 0) {
			...
			this.gl.drawElements(this.gl.TRIANGLES, mesh.quadIndices(), mesh.indexType ?? this.gl.UNSIGNED_SHORT, 0)
		}
